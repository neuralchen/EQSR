...
class LTE_imagenet_Dataset(data.Dataset):
    def __init__(  
                    self,
                    opt
                ):
        super(LTE_imagenet_Dataset, self).__init__()
        ...
        self.sample_q = lr_patch_size*lr_patch_size
    ...
    def __getitem__(self, index):
        ...
        return {'lq': crop_lr, 'gt': hr_rgb, 'gt_path': self.div2k_root, 'coord':hr_coord, "cell":cell}
